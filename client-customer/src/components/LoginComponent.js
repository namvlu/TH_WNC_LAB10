...
class Login extends Component {
  ...
  constructor(props){ super(props); this.state = { txtUsername:'sonkk', txtPassword:'123' }; }
  ...
  btnLoginClick(e){
    e.preventDefault();
    const username=this.state.txtUsername, password=this.state.txtPassword;
    if(username && password){ const account = { username:username, password:password }; this.apiLogin(account); }
